...
- **[Runbook Relay](/projects/runbook-relay/):** built and maintain a deterministic WebMCP control room with five bounded tools, durable server policy, session-bound approval, replay protection, hash-linked receipts, 23 automated tests, and a versioned 50-task evaluation contract.
...
I helped run an Amazon Bedrock AgentCore Immersion Day for more than 100 participants. Within that program, I designed and delivered a separate evaluation and policy module extension for a cohort of about 30 participants. The distinction matters: the larger event demonstrates program delivery, while the smaller module reflects the material I personally built and taught.
