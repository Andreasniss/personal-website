...
make_card "context-and-control.png" "Article" "AI Agents Need Separate Context and Control Layers" "Why better information does not replace execution boundaries." "#45aaa2" "54"
